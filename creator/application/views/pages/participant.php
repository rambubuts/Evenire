                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="card">
                                                    <div class="header">
                                                        <center>
                                                            <label style="font-size: 25px; font-family: Century Gothic; color: black; font-weight: bold;" id="textLabel">Register Event</label>
                                                        </center>
                                                    </div>
                                                    <div class="content">
                                                        <div class="row" style="padding: 10px;">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <h3 style="color: black; font-weight: bold; font-family: Century Gothic;">Event Information</h3>
                                                                    <h6>Select your desired event.</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row" style="padding: 10px;">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control">
                                                                        ...
                                                                        <option>ICT Congress</option>
                                                                        <option>DICT Conference</option>
                                                                        <option>PSITE Talk</option>
                                                                        <option>IT Solution Project Innovation Seminar</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row" style="padding: 10px;">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label style="color: black;">Event Location* </label>
                                                                    <input type="text" class="form-control" placeholder="Input desired place">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row" style="padding: 10px;">
                                                        ...
                                                        <div class="row" style="padding: 10px;">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <h3 style="color: black; font-weight: bold; font-family: Century Gothic;">Personal Information</h3>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row" style="padding: 10px;">
                                                        ...
                                                        <div class="row" style="padding: 10px;">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label style="color: black;">Cell Phone*</label>
                                                        ...
                                                        <div class="row" style="padding: 10px;">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <h3 style="color: black; font-weight: bold; font-family: Century Gothic;">Work Information</h3>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                            ...
                            <div class="modal-footer">
                              <button type="submit" class="btn btn-warning btn-fill pull-right" id="addPatient"><span><i class="fa fa-plus-circle fa-lg"></i></span>&nbsp;&nbsp;Complete Registration</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor mb-0 mt-0">Participants</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-md-6 col-4 align-self-center">
                        ...
                        <button class="btn float-right hidden-sm-down btn-success" data-toggle="modal" data-target="#myModal"><i class="mdi mdi-plus-circle"></i> Register Walk-in</button>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of Participants</h4>
                                <h6 class="card-subtitle">Participants</h6>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="myTable" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 250px;">Participant Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 150px;">Address</th>
                                                <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 50px;">Contact No.</th>
                                                <th class="sorting" tabindex="0" aria-controls="myTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 40px;">Joined Event</th>
                                        ...
                                        <tbody>
                                            <?php foreach ($data as $key => $val) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $val->account_address; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $val->account_contact; ?>
                                                    </td>
                                                    <td>

                                                    </td>
                                                    <td>
                                                        <button type="submit" class="btn btn-danger btn-fill pull-right"><span><i class="mdi mdi-information"></i></span>&nbsp;Deactivate</button>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
